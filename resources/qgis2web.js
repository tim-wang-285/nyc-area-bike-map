...
map.getView().fit([-8249496.987731, 4966482.993893, -8237932.558758, 4975741.157928], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">NYC Area Bike Map</h2>';
        return titleElement;
    })(),
    ...
    element: (() => {
        ...
        if (80 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = 'Data Source: New York City Open Data, Hoboken Mapping Hub, Jersey City Open Data';
            }
