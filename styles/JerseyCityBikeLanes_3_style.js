var size = 0;
var placement = 'point';
function categories_JerseyCityBikeLanes_3(feature, value, size, resolution, labelText,
                       labelFont, labelFill, bufferColor, bufferWidth,
                       placement) {
                var valueStr = (value !== null && value !== undefined) ? value.toString() : 'default';
                switch(valueStr) {case 'BIKE LANE':
...
case 'SHARED USE PATH':
                    return [ new ol.style.Style({
        stroke: new ol.style.Stroke({color: 'rgba(153,223,90,1.0)', lineDash: null, lineCap: 'square', lineJoin: 'bevel', width: 2.508}),
        text: createTextStyle(feature, resolution, labelText, labelFont,
                              labelFill, placement, bufferColor,
                              bufferWidth)
    })];
...
var style_JerseyCityBikeLanes_3 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    ...
    var style = categories_JerseyCityBikeLanes_3(feature, value, size, resolution, labelText,
