...
var format_HobokenBikeLanes_1 = new ol.format.GeoJSON();
var features_HobokenBikeLanes_1 = format_HobokenBikeLanes_1.readFeatures(json_HobokenBikeLanes_1, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_HobokenBikeLanes_1 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_HobokenBikeLanes_1.addFeatures(features_HobokenBikeLanes_1);
var lyr_HobokenBikeLanes_1 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_HobokenBikeLanes_1, 
                style: style_HobokenBikeLanes_1,
                popuplayertitle: 'Hoboken Bike Lanes',
                interactive: true,
                title: '<img src="styles/legend/HobokenBikeLanes_1.png" /> Hoboken Bike Lanes'
            });
var format_JerseyCityBikeLanes_2 = new ol.format.GeoJSON();
var features_JerseyCityBikeLanes_2 = format_JerseyCityBikeLanes_2.readFeatures(json_JerseyCityBikeLanes_2, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_JerseyCityBikeLanes_2 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_JerseyCityBikeLanes_2.addFeatures(features_JerseyCityBikeLanes_2);
var lyr_JerseyCityBikeLanes_2 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_JerseyCityBikeLanes_2, 
                style: style_JerseyCityBikeLanes_2,
                popuplayertitle: 'Jersey City Bike Lanes',
                interactive: true,
    title: 'Jersey City Bike Lanes<br />\
    <img src="styles/legend/JerseyCityBikeLanes_2_0.png" /> BIKE LANE<br />\
    <img src="styles/legend/JerseyCityBikeLanes_2_1.png" /> PROTECTED BIKE LANE<br />\
    <img src="styles/legend/JerseyCityBikeLanes_2_2.png" /> SHARED USE LANE<br />\
    <img src="styles/legend/JerseyCityBikeLanes_2_3.png" /> SHARED USE PATH<br />\
    <img src="styles/legend/JerseyCityBikeLanes_2_4.png" /> <br />' });
var format_HobokenProtectedOffroad_3 = new ol.format.GeoJSON();
var features_HobokenProtectedOffroad_3 = format_HobokenProtectedOffroad_3.readFeatures(json_HobokenProtectedOffroad_3, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_HobokenProtectedOffroad_3 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_HobokenProtectedOffroad_3.addFeatures(features_HobokenProtectedOffroad_3);
var lyr_HobokenProtectedOffroad_3 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_HobokenProtectedOffroad_3, 
                style: style_HobokenProtectedOffroad_3,
                popuplayertitle: 'Hoboken Protected & Off-road',
                interactive: true,
    title: 'Hoboken Protected & Off-road<br />\
    <img src="styles/legend/HobokenProtectedOffroad_3_0.png" /> Off-Street Bike Path<br />\
    <img src="styles/legend/HobokenProtectedOffroad_3_1.png" /> Protected Bike Lane<br />\
    <img src="styles/legend/HobokenProtectedOffroad_3_2.png" /> Waterfront Walkway<br />\
    <img src="styles/legend/HobokenProtectedOffroad_3_3.png" /> <br />' });
var format_NYCBikeRoutes_4 = new ol.format.GeoJSON();
var features_NYCBikeRoutes_4 = format_NYCBikeRoutes_4.readFeatures(json_NYCBikeRoutes_4, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_NYCBikeRoutes_4 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_NYCBikeRoutes_4.addFeatures(features_NYCBikeRoutes_4);
var lyr_NYCBikeRoutes_4 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_NYCBikeRoutes_4, 
                style: style_NYCBikeRoutes_4,
                popuplayertitle: 'NYC Bike Routes',
                interactive: true,
    title: 'NYC Bike Routes<br />\
    <img src="styles/legend/NYCBikeRoutes_4_0.png" /> Protected<br />\
    <img src="styles/legend/NYCBikeRoutes_4_1.png" /> Conventional<br />\
    <img src="styles/legend/NYCBikeRoutes_4_2.png" /> Shared Lane / Signed Route<br />\
    <img src="styles/legend/NYCBikeRoutes_4_3.png" /> Link<br />\
    <img src="styles/legend/NYCBikeRoutes_4_4.png" /> <br />' });
